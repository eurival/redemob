...
VALUES
  ('791.331.471-81','2022-10-10','condimentum@hotmail.couk','Marshall de Azevedo','Peter Inacio'),
  ('334.538.293-48','2023-06-19','ipsum.nunc.id@outlook.couk','Lucius Magalhaes','Dolan Mendes'),
  ('815.407.545-52','2022-05-08','at.iaculis.quis@hotmail.couk','Juliet de Melo','Oscar da Rocha'),
  ('369.202.504-62','2023-04-04','amet@google.couk','Charlotte de Fatima','Ivana Magalhaes'),
  ('585.175.811-37','2023-05-09','consequat@yahoo.com','Dai Pereira','Yvette da Silveira'),
  ('513.426.435-81','2021-12-28','eros.proin@yahoo.com','Reagan Nonato','Mollie Pacheco'),
  ('565.412.601-68','2021-09-19','eurival_b@hotmail.com','admin','admin');

   

INSERT INTO inscricao (bairro,endereco,status,complemento,cidade_id,pessoa_id, data_inscricao)
VALUES
  ('Colombo','918-2571 Nullam Av.','EM ANALISE','-0.0310996665',4,1,(select (current_timestamp at time zone 'UTC') at time zone 'UTC')),
  ('Abaetetuba','Ap #152-8117 Volutpat. St.','EM ANALISE','0.0479106541',5,2, (select (current_timestamp at time zone 'UTC') at time zone 'UTC')),
  ...
  ('Colombo','Ap #922-7794 A Rd.','EM ANALISE','-0.3042054370',4,7, (select (current_timestamp at time zone 'UTC') at time zone 'UTC')),
  ('Sousa','692-1478 In, Ave','EM ANALISE','-0.0187711048',7,1, (select (current_timestamp at time zone 'UTC') at time zone 'UTC')),
  ...
  INSERT INTO usuario (senha,pessoa_id,admin)
VALUES
  ('MFY40DVX2GT',1,false),
  ('NZP58XLT2WW',2,false),
  ('MTP77PZM3ME',3,false),
